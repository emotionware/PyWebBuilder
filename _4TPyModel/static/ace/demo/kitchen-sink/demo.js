...
optionsPanelContainer.insertBefore(
    dom.buildDom(["div", {style: "visibility:hidden; text-align:right;margin-right: 60px"},
        ["div", {}, 
            ["button", {onclick: env.editSnippets}, "Ver Snippets"]],
        ["div", {}, 
            ],
        devUtil.getUI()
    ]),
