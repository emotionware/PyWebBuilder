...
var db = '4tempty';
function formbuild() { 
var form = FormApp.create("Documentación Interna"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Documentación Interna');
...
var sentencia="insert into tbldocumentacioninterna(NOMBRE_DOC,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "')";
