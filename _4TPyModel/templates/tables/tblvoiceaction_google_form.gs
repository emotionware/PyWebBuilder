...
var db = '4tempty';
function formbuild() { 
var form = FormApp.create("Voice Actions"); 
var conexion=conectar_mysql(); //realizo conexion con mysql



var guardar = SpreadsheetApp.create('Voice Actions');
...
var sentencia="insert into tblvoiceaction(MENSAJE,URLACTION,OBSERVACIONES) values ('"  + itemResponses[0].getResponse() + "','"  + itemResponses[1].getResponse() + "','"  + itemResponses[2].getResponse() + "')";
