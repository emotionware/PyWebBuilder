<script>
$(document).ready(function () { $("#IDDOCUMENTACIONINTERNA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDDOCUMENTACIONINTERNA").val(); 
 });}); 

 $(document).ready(function () { $("#NOMBRE_DOC").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#NOMBRE_DOC").val(); 
 });}); 
